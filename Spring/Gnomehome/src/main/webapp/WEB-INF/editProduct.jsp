...
<body>
	<div class="container">
		<div class="d-flex justify-content-between align-items-center">
			<h1>Update a Product Listing</h1>
			<a href="/dashboard" class="btn btn-dark ml-3">Home</a>
		</div>
		<form:form action="/products/${oneProduct.id}/update" method="post" modelAttribute="oneProduct">
			...
			<a href="/products/${ oneProduct.id }/delete" class="btn btn-danger ml-3">Delete</a>
